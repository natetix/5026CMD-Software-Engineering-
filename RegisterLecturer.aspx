...
<head runat="server">
    ...
    <title>Register Lecturer &middot; SIMS</title>
...
<form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="nav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="RegisterLecturer.aspx">Register Lecturer</a></li>
    ...
    <div class="sims-page">
        <div class="container-fluid px-4">
            ...
            <h1 class="mb-3">Register New Lecturer</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    <h2 class="h5 mb-3">Registered Lecturers</h2>
                    <div class="table-responsive">
                        <asp:GridView ID="gvLecturers" runat="server" AutoGenerateColumns="False" CssClass="sims-table" GridLines="None">
                            <Columns>
